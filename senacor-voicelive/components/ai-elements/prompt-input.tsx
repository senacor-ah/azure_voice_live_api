...
// Type shims (replaces `ai` package dependency)
type ChatStatus = 'idle' | 'loading' | 'error' | 'streaming' | 'submitted' | 'ready';
type FileUIPart = { type: 'file'; mediaType: string; url: string; filename?: string };
import {
  CornerDownLeftIcon,
  ImageIcon,
  Loader2Icon,
